...
const (
	...
	TLS_CIPER_SUITE_SSL_DHE_RSA_WITH_DES_CBC_SH           TLSCipherSuite = 0x0015
...
func DecryptMessage(recordLayerData []byte, encryptedData []byte, serverData *common.ServerData) []byte {

	switch TLSCipherSuite(serverData.SelectedCipherSuite) {
	case TLS_CIPER_SUITE_SSL_DH_RSA_WITH_DES_CBC_SHA:
	default:
		return DecryptDesMessage(recordLayerData, encryptedData, serverData)
	}
